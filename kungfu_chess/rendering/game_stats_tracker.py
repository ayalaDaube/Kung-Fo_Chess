...
class GameStatsTracker:
    """
    Pure UI/stats layer. Listens to RealTimeEvents from GameEngine.wait()
    and accumulates move history and scores. No game logic.
    """
    ...
    def _record_move(self, event: ArrivalEvent) -> None:
        ...
        col = _COL_LETTERS[event.destination.col]
