...
RegistryProtocol defines the interface both ConnectionRegistry (in-memory)
and RedisConnectionRegistry (Redis-backed) implement.  All gateway code
accepts RegistryProtocol so the backing store is swappable at wiring time.
"""
...
class RegistryProtocol(Protocol):
    """Structural interface shared by ConnectionRegistry and RedisConnectionRegistry."""
